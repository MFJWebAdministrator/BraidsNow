...
const webhookSecret =
  process.env.STRIPE_WEBHOOK_SECRET || "whsec_uD5UVYJitxHFVXEpFRd7lMT66zOCnqiX";
    ...
    switch (event.type) {
      ...
      case "customer.subscription.updated": {
        ...
        if (!stylistsQuery.empty) {
          ...
          if (
            stylistDoc.data()?.subscription?.cancelAtPeriodEnd === true &&
            ...
            if (stylistId) {
              ...
              await db
                ...
                .add({
                  ...
                  amount: transfer.amount,
                  description:
                    withdrawalData?.description || "Withdrawal to bank account",
                  status: "completed",
                  createdAt: admin.firestore.FieldValue.serverTimestamp(),
                  completedAt: admin.firestore.FieldValue.serverTimestamp(),
                });
