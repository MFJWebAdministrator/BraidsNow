      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-gray-500">Update Your Stylist Profile</p>
          </CardHeader>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:gap-8">
              <div className="flex items-center gap-8 mb-4 md:mb-0">
                {userData?.profileImage && (
                  <Avatar className="h-24 w-24">
                    <AvatarImage src={userData.profileImage} alt="Current profile" />
              ...
              <div className="flex-1">
                <FormItem>
                  <FormLabel className="text-md text-[#3F0052] font-light tracking-normal">Your BraidsNow Unique Link</FormLabel>
                  <FormControl>
                    <Input 
                      value={`https://braidsnow.com/${userData?.username || ''}`}
                      disabled
                      className="bg-gray-50"
                    />
                  </FormControl>
                  <p className="text-sm text-black mt-1 text-md tracking-normal">Share this link to promote your services</p>
                </FormItem>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Business Name</FormLabel>
                    <FormControl>
                      <Input {...field} className="form-input" />
                    </FormControl>
                    <FormMessage />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Phone</FormLabel>
                    <FormControl>
                      <Input {...field} className="form-input" />
                    </FormControl>
                    <FormMessage />
            ...
            <div className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Introduction</FormLabel>
                    <FormControl>
                      <Textarea 
                        {...field}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Special Instructions</FormLabel>
                    <FormControl>
                      <Textarea 
                        {...field}
                        className="min-h-[100px] border-[#3F0052] focus:ring-[#3F0052]/20 focus:border-[#3F0052] rounded-lg text-md tracking-normal"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Policy and Procedures</FormLabel>
                    <FormControl>
                      <Textarea 
                        {...field}
                        className="min-h-[100px] border-[#3F0052] focus:ring-[#3F0052]/20 focus:border-[#3F0052] rounded-lg text-md tracking-normal"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <FormField
                    key={service.name}
                    control={form.control}
                    name={service.name as keyof StylistSettingsForm}
                    render={({ field }) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Deposit Amount</FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">BraidsNow Coupon Code</FormLabel>
                    <FormControl>
                      <Input
            ...
            <div className="space-y-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Business Address</FormLabel>
                    <FormControl>
                      <Input {...field} className="form-input" />
                    </FormControl>
                    <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input {...field} className="form-input" maxLength={5} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
