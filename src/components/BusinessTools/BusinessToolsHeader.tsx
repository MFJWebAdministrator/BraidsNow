...
export function BusinessToolsHeader() {
  return (
    <div className="relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-light text-white mb-4 font-light tracking-normal">
            Business Tools for Stylists
          </h1>
          <p className="text-xl text-white tracking-normal font-light max-w-2xl mx-auto">
            Everything you need to manage and grow your hair styling business
          </p>
        </div>
      </div>
    </div>
