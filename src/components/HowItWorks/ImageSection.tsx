  ...
  return (
    <div className="relative">
      <div className="relative rounded-2xl overflow-hidden">
        <img
          src="/images/Your Journey to Beautiful Styles.jpg"
      ...
      <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-6 max-w-xs">
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm text-black-500 font-light tracking-normal">
            {" "}
            Success Rate
          </span>
          <span className="text-lg font-light" style={{ color: "#3F0052" }}>
            98%
          </span>
        </div>
        <div className="w-full bg-gray-200 rounded-full h-2">
          <div
            ...
            style={{ backgroundColor: "#3F0052", width: "98%" }}
          />
        </div>
