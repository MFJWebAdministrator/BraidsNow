...
export function StylistCard({ stylist, onToggleFavorite, onViewProfile }: StylistCardProps) {
  ...
  const handleProceedToPayment = async () => {
    ...
    try {
      ...
      const successUrl = `${origin}/payment-success?stylistId=${stylist.id}`;
      const cancelUrl = `${origin}/payment-cancel?stylistId=${stylist.id}`;
      
      // Call the API to create a payment checkout session
      ...
      if (error.response?.data?.error === "Stylist does not have an active payment account") {
        errorMessage = "This stylist is not set up to receive payments yet.";
      ...
      // Set error message in state for display in the dialog
    ...
    <>
      ...
      <Dialog open={paymentDialogOpen} onOpenChange={setPaymentDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-center text-xl">Book Appointment</DialogTitle>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h4 className="font-medium">{stylist.businessName}</h4>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-medium">${amount/100}</span>
              </div>
              
              <div className="flex justify-between items-center mt-1">
                <span className="text-sm text-gray-600">Platform Fee</span>
                <span className="font-medium">${platformFee/100}</span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-bold text-lg">${totalAmount/100}</span>
              </div>
            </div>
            
            {/* Payment Notice */}
            <div className="text-sm text-gray-500">
              <p>By proceeding, you agree to our Terms of Service and Privacy Policy. You'll be redirected to our secure payment processor to complete your booking.</p>
            </div>
          </div>
