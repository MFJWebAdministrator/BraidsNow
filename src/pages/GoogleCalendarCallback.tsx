...
import { saveGoogleCalendarTokens } from "@/lib/api-client";
import {
    Card,
    CardContent,
    CardDescription,
        ...
        const handleCallback = async () => {
            ...
            try {
                ...
                toast({
                    ...
                    description:
                        "Your Google Calendar has been successfully connected. Your appointments will now sync automatically.",
                    duration: 3000,
                });
                ...
                console.error(
                    "Error handling Google Calendar callback:",
                    error
                );
                setStatus("error");
                setErrorMessage(
            ...
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        ...
                        {status === "success" &&
                            "Your Google Calendar has been successfully connected. Redirecting..."}
