        ...
        <footer className="bg-[#3F0052] text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {/* About */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 tracking-normal">
                            About BraidsNow.com
                        </h3>
                        <p className="text-white font-light tracking-normal">
                            BraidsNow.com is a resource for all things Braids
                            and Black Hair. We believe hairstyles are a work of
                            art and should be appreciated as such.
                        </p>
                    </div>
