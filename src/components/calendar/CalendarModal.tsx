...
export function  CalendarModal({
  ...
  const isExistingAppointment = selectedEvent && !isRecurringBreak && !selectedEvent.extendedProps?.isCustomEvent;
    ...
    try {
      if (data.isRecurring) {
        ...
        toast({
          ...
          description: "Your recurring break has been added to your schedule successfully.",
        });
      } else {
        ...
        if (data.eventType === 'break' || data.eventType === 'lunch') {
          ...
          const dayOfWeek = dayNames[selectedDate.getDay()] as Break['days'][0];
          ...
          <div className="space-y-4">
            <div className="p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-600 mb-2">
                This is a recurring break from your schedule settings. To modify this break, please go to your Schedule settings.
              </p>
            </div>
  ...
  if (isExistingAppointment) {
    ...
    const endTime = calculateEndTime(appointment.time, appointment.service?.duration || { hours: 1, minutes: 0 });
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div key={day.value} className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => {
                          if (checked) {
                            setValue('days', [...watchedDays, day.value]);
                          } else {
                            setValue('days', watchedDays.filter(d => d !== day.value));
                          }
                        }}
                      />
            ...
            <>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select onValueChange={(value) => setValue('eventType', value as any)} defaultValue={watch('eventType')}>
                    <SelectTrigger className="mt-1">
          ...
          <div className="flex justify-end space-x-2 pt-4">
            ...
            >
              ...
              {isSubmitting ? 'Saving...' : (watchedIsRecurring ? 'Create Recurring Event' : 'Create Event')}
            </Button>
          </div>
        </form>
      </DialogContent>
