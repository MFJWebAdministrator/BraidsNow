...
export function SearchSection({ searchParams, onSearchChange }: SearchSectionProps) {
  return (
        ...
        <div className="flex items-center p-2">
          <div className="flex-1 grid grid-cols-3 gap-2">
            <Input
              ...
              onChange={(e) => onSearchChange({ ...searchParams, businessName: e.target.value })}
            ...
            <Input
              ...
              onChange={(e) => onSearchChange({ ...searchParams, styles: e.target.value })}
              className="border-2 border-[#3F0052]/20 focus:border-[#3F0052] shadow-none bg-transparent rounded-full"
            />
            <Input
