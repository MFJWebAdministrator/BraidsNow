  ...
  const handleCancelAccount = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your account has been successfully cancelled. We're sorry to see you go!",
      });
            ...
            <CardContent className="space-y-8">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:gap-8">
                ...
                <div className="flex-1 max-w-sm">
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Username</FormLabel>
                    <FormControl>
                      <Input 
                    ...
                    <p className="text-sm text-gray-500 mt-1">Username cannot be changed after registration</p>
                  </FormItem>
                </div>
              </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-md text-[#3F0052] font-light">Street Address (Optional)</FormLabel>
                    <FormControl>
                      <Input {...field} className="form-input" />
                    </FormControl>
                    <FormMessage />
            ...
            <AlertDialogDescription asChild>
              <div className="space-y-4">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 space-y-2">
                  <div className="font-medium text-amber-800">You will lose access to:</div>
                  <ul className="list-disc list-inside text-amber-700 space-y-1">
                    <li>Your saved favorite stylists</li>
                    <li>Your style board and uploaded images</li>
                    <li>Your booking history and upcoming appointments</li>
                    <li>Your messaging history with stylists</li>
