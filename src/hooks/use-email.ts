...
import {
    ...
    sendAppointmentConfirmationStylist as sendAppointmentConfirmationStylistAPI,
    sendPaymentFailureStylist as sendPaymentFailureStylistAPI,
    ...
    sendFullPaymentReminderClient as sendFullPaymentReminderClientAPI,
...
export const useEmail = () => {
    ...
    const sendAppointmentConfirmationStylist = async (
        data: StylistAppointmentData
    ) => {
        await sendEmail(() => sendAppointmentConfirmationStylistAPI(data));
    };
    ...
    const sendFullPaymentReminderClient = async (
        data: FullPaymentReminderData
    ) => {
        await sendEmail(() => sendFullPaymentReminderClientAPI(data));
    };

    // Payment & Account Emails
    const sendPaymentFailureStylist = async (data: PaymentFailureData) => {
        await sendEmail(() =>
    ...
    return {
        ...
        sendFullPaymentReminderClient,
        sendPaymentFailureStylist,
